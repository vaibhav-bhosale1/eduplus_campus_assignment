...
const Navbar: React.FC = () => {
  const { user, logout, isAuthenticated, isAdmin, isNormalUser, isStoreOwner } =
    useAuth();
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        d="M5.121 17.804A3 3 0 017.88 16h8.24a3 3 0 012.758 1.804M12 12a4 4 0 100-8 4 4 0 000 8z"
                      />
                    </svg>
